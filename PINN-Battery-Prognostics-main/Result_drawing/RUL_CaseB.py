...
# 读取三个结果文件
baseline_results = torch.load(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'Results', '4 Presentation', 'RUL Prognostics', 'RUL_CaseB_Baseline.pth'), weights_only=False)
adpbal_results = torch.load(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'Results', '4 Presentation', 'RUL Prognostics', 'RUL_CaseB_DeepHPM_AdpBal.pth'), weights_only=False)
sum_results = torch.load(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'Results', '4 Presentation', 'RUL Prognostics', 'RUL_CaseB_DeepHPM_Sum.pth'), weights_only=False)
