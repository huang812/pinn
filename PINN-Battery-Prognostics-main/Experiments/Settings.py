...
# 原 num_layers 可对应到 Neural_Net 类中 GRU 层数，修改为列表形式
settings_SoH_CaseA['gru_num_layers'] = 2
# 原 num_neurons 对应到 GRU 隐藏单元数量，修改为列表形式
settings_SoH_CaseA['gru_hidden_size'] = 128
...
settings_SoH_CaseB['gru_num_layers'] = [2]
settings_SoH_CaseB['gru_hidden_size'] = [128]
...
settings_RUL_CaseA['num_epoch'] = 500
# 原 num_layers 可对应到 Neural_Net 类中 GRU 层数，修改为列表形式
settings_RUL_CaseA['gru_num_layers'] = [2]
# 原 num_neurons 对应到 GRU 隐藏单元数量，修改为列表形式
settings_RUL_CaseA['gru_hidden_size'] = [64]
settings_RUL_CaseA['lr'] = 1e-3
settings_RUL_CaseA['step_size'] = 50000
settings_RUL_CaseA['gamma'] = 0.1
settings_RUL_CaseA['inputs_lib_dynamical'] = ['s_norm, t_norm']
settings_RUL_CaseA['inputs_dim_lib_dynamical'] = ['inputs_dim']
...
settings_RUL_CaseB['gru_num_layers'] = [3]
settings_RUL_CaseB['gru_hidden_size'] = [64]
...
settings_RUL_CaseC['gru_num_layers'] = [4]
settings_RUL_CaseC['gru_hidden_size'] = [128]
