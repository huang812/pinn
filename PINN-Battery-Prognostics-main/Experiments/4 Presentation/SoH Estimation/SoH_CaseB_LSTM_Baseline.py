...
torch.save(
    results,
    '..\\..\\..\\Results\\4 Presentation\\SoH Estimation\\SoH_CaseB_LSTM_Baseline.pth'
)
...
print('Results saved to: ..\\..\\..\\Results\\4 Presentation\\SoH Estimation\\SoH_CaseB_LSTM_Baseline.pth')